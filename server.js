...
router.get("/create-and-save-person", function (req, res, next) {
  ...
  createPerson(function (err, data) { //func param done
    clearTimeout(t);
    if (err) {
      return next(err);
    }
...
const findByName = require("./myApp.js").findPeopleByName; // call func "findPeopleByName" and save in a variable "findByName"
router.post("/find-all-by-name", function (req, res, next) {
  ...
  Person.create(req.body, function (err, pers) {
    ...
    findByName(pers.name, function (err, data) { // execute func "findPeopleByName" saved in variable "findByName" with key "pers.name" as first param to find. And anonime function as te code for be executing inside of "findPeopleByName" function hosted in myApp.js file 
      clearTimeout(t);
      if (err) {
        return next(err);
      }
